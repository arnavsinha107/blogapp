...
const GhostCursor = ({
  ...
  useEffect(() => {
    ...
    let active = true;
    console.log("GhostCursor mounting. Host size rect:", host.getBoundingClientRect());

    const computedPos = window.getComputedStyle(parent).position;
    const needsRelative = computedPos === 'static';
    if (needsRelative) {
    ...
    const resize = () => {
      ...
      console.log("GhostCursor resize event. Width:", cssW, "Height:", cssH);
